            ...
            <div class="col-lg-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 pt-4" id="artikel">
                        ...
                        <?php
                        include 'koneksi.php';
                        $query = mysqli_query($con,"SELECT * FROM artikel ORDER BY nama_kategori ASC LIMIT 3");
                        while($row= mysqli_fetch_assoc($query)){  
                        ?>
                            <div class="col-md-4">
                                <img src="../assets/img/thumbnail/<?php echo $row['gambar'];?>" alt="..." class="w-100 pb-4">
                            </div>
                            <div class="col-md-8">
                    ...
                    <div class="col-md-12 pt-4" id="artikel">
                        <img width="765px" height="422px" src="../assets/img/womanspotliteatas.png">
                        <h3 class="second-txt">
                        Perilaku laki-laki yang membuat <br> wanita bangga
                        </h3>
                    </div>
