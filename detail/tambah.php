<form action="" method="post" role="form" enctype="multipart/form-data">
        ...
        if(isset($_POST['submit'])){
            ...
            //             $sql = mysql_query($con,"INSERT INTO rekomendasi(gambar) VALUES ('$fileNameNew')");
            //             header("Location: ");
            //         }  else {
            //             echo "Berhasil !";
            //         }                 
            ...
            if($fileError === 0) {
                if ($fileSize > 125000) {
                    ...
                    if (in_array($fileActualExt,$allowed)) {
                        ...
                        $fileDestination = '../assets/img/rekomendasi/'.$fileNameNew;
                        move_uploaded_file($fileTmpName,$fileDestination);
                        $sql = mysqli_query($con,"INSERT INTO rekomendasi(judul,gambar) VALUES ('$judul','$fileNameNew')");
